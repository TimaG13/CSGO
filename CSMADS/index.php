	...
	<div class="rightbar" id="rightbar">
        ...
        ?>	<div class="inform">
			...
			<div class="right">
				...
				<a href="/deposit.php" target="_blank" class="add-item left"><?=$msg['deposite']?></a>
			</div>
		</div>	<?php 
        ...
        ?>	<div class="right">
				<a href="/deposit.php" target="_blank" class="add-item left"><?=$msg['deposite_one']?></a>
			</div>	<?php 
...
<div class="copyright">Рулетка была сделана студией - <a href="http://getscripts.ru">GetScripts.ru</a></div>
</div>
<!-- </middle> -->
<div class="clear"></div>
</div>
