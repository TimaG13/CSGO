	...
	$.ajax({
		...
		(message[i].user_name.indexOf('EZYSKINS.RU')>-1)?gold='style="color:gold;"':"";
					...
					item += '	<div class="top hidden">';
							...
							item += '<ul>';
							item += '	<li><a class="user_title_linka" '+gold+' original-title="Перейти в профиль" href="http://steamcommunity.com/profiles/'+message[i].user_id+'" target="_blank">'+message[i].user_name+'</a></li>';
