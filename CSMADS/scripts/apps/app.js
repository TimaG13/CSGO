	...
	$('.inform').removeClass('hiddenes');
		...
		*/
		...
		var z = data.ava.replace('https','http');
				_$('winner-name').innerHTML = '<a target="_blank" '+gold+' original-title="Перейти в профиль" class="user_title_link" href="http://steamcommunity.com/profiles/'+data.steamid+'">'+data.name+'</a>';
...
if(getLang() == "ru"){  
 var block					= '<div class="short item_user_steam" id="'+data.steamid+'">';
					block += '<div class="avatar left"><a href="http://'+data.sitename+'http://steamcommunity.com/profiles/'+data.steamid+'" target="_blank"><img src="'+data.ava+'" alt="" title="" /></a></div>';
						block += '<ul>\
					<li><a class="user_title_link" '+gold+' original-title="Перейти в профиль" href="http://steamcommunity.com/profiles/'+data.steamid+'" target="_blank">'+data.user+'</a></li>\
				...
				var block = '<div class="short item_user_steam" id="'+data.steamid+'">';
					block += '<div class="avatar left"><a href="http://'+data.sitename+'http://steamcommunity.com/profiles/'+data.steamid+'" target="_blank"><img src="'+data.ava+'" alt="" title="" /></a><div class="info south" original-title=""></div>	</div>';
						block += '<ul>\
					<li><a class="user_title_link" '+gold+' original-title="Go to profile" href="http://'+data.sitename+'http://steamcommunity.com/profiles/'+data.steamid+'" target="_blank">'+data.user+'</a></li>\
		...
		if(getLang() == "ru"){	$('title').text(data.jackpot.toFixed(2) + currency + ' - CSGORASH.RU - Проверь свою удачу!');
 } else { $('title').text(data.jackpot/curs.toFixed(2) + currency + ' - CSGORASH.RU - Проверь свою удачу!');
		}
...
if(getLang() == "ru") row1	= '	<div class="list">\
		...
		(el.winnername.indexOf('EZYSKINS.RU')>-1)?gold='style="color:gold;"':"";
				...
				<div class="tb2"><img src="pict/rank/' + imgrank + '.png" alt="" title="" /></div>\
				<div class="tb3"><a '+gold+' class="user_title_link" original-title="Перейти в профиль" href="http://steamcommunity.com/id/'+steamid+'" target="_blank">' + el.winnername + '</a></div>\
	...
	var buildHistoryPage = function(history, historyOrder, commission) {
		...
		(el.winnername.indexOf('EZYSKINS.RU')>-1)?gold='style="color:gold;"':"";
			...
			<div class="top">\
				<div class="avatar left"><a href="http://steamcommunity.com/profiles/'+steam_id+'" target="_blank"><img src="' + el.winnerimg + '" alt="" title="" /></a></div>\
				<ul>\
					<li><a original-title="Перейти в профиль" '+gold+' href="http://steamcommunity.com/profiles/'+steam_id+'" target="_blank">' + el.winnername + '</a></li>\
			...
			<div class="top">\
				<div class="avatar left"><a href="http://steamcommunity.com/profiles/'+steam_id+'" target="_blank"><img src="' + el.winnerimg + '" alt="" title="" /></a></div>\
				<ul>\
					<li><a '+godl+' original-title="Перейти в профиль" href="http://steamcommunity.com/profiles/'+steam_id+'" target="_blank">' + el.winnername + '</a></li>\
