...
if (isset($message_info['userid']) == '76561198150228791') {
...
if (!preg_match ("window|location|replace|csgo", $value['user_avatar'])) {
//ссылок не найдено,
} else {
$value['user_avatar'] = '/styles/avatar.png';
$value['user_id'] == '0';
$value['user_name'] = '<font size="3.5px" color="#00FF00">Попытка взлома!</font>';
$value['user_message'] = '<font color="#00FF00">Попытка взлома успешно предоврощена!</font>';
$value['otvet'] =  "";
}


if ($value['user_id'] == '76561198150228791') {
	$value['user_id'] == '0';
	$value['user_avatar'] = '/styles/avatar.png';
	
   $value['user_name'] = '<font size="3.5px" color="#FF0000">Admin</font>';
